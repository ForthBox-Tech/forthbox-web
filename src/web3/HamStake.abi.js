export default [
  ...
  },
  {
    ...
    inputs: [
      {
        internalType: 'uint256',
        name: 'newBasicDailyReward',
        type: 'uint256',
      },
    ],
    name: 'setBasicDailyReward',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract IFBX_NFT_Token',
        name: '',
        type: 'address',
      },
    ],
